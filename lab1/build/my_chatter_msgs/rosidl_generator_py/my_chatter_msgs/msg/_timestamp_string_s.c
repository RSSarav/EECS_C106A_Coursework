...
bool my_chatter_msgs__msg__timestamp_string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_chatter_msgs.msg._timestamp_string.TimestampString", full_classname_dest, 53) == 0);
  }
  my_chatter_msgs__msg__TimestampString * ros_message = _ros_message;
  {  // msg
...
{
  /* NOTE(esteve): Call constructor of TimestampString */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_chatter_msgs.msg._timestamp_string");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TimestampString");
