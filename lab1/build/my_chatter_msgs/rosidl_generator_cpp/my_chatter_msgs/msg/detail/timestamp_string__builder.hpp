...
class Init_TimestampString_msg
{
public:
  Init_TimestampString_msg()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TimestampString_timestamp msg(::my_chatter_msgs::msg::TimestampString::_msg_type arg)
  {
...
{
  return my_chatter_msgs::msg::builder::Init_TimestampString_msg();
}
